...
This file is the input file for a github action "Build Hash Page". The action produces hash.html that you can upload so that students can use it to check their downloaded images. Modify the below strings to match the images you are using on the course. Preserve the formatting because the python program in "Build Hash Pages" action assumes it. 
...
- debian.ova `95452b8e7b9c9d78ad2d3b828255f505b32bc5f8857b6eaf60d163d84b6e2830`
