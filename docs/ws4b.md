...
For example, the system can be configured to **enforce strong password policies**, and in the case of SSH, to disable password-based authentication and require key-based login instead
